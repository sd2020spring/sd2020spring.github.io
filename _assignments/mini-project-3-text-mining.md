...
class_slides: https://docs.google.com/presentation/d/1ym5O2yn-lxSBfyAavd5LC5k-SSbe75RnUjV-n39SSNk/edit?usp=sharing 
sp_19_examples: https://docs.google.com/presentation/d/18OgZ18wZEurC_nja5f2y8C4CK46PDVbVacQu_cR4pns/edit?usp=sharing
...
You will also think about the possible uses of your program and this technology: How can text mining and analysis be used for good? What are some harms that can come from this technology? What are the limitations of certain data sets and text mining approaches and how do they affect the impact of your software for good or harm? How should you talk about what your software and analysis can and can't do when presenting your results? 
...
Here are some resources with different examples of text mining:
 - [Computational Ethics Project Ideas for CMU Course](https://docs.google.com/document/d/1a_XrySzfEPG_WpguiUdWJPFCQljgICy7z-lOpc_VEJA/edit)
 - [Sentiment Analysis in Elections](https://www.nytimes.com/2010/11/01/technology/01sentiment.html)
 - [A Survey on Sentiment Analysis Challenges](https://www.researchgate.net/publication/301649355_A_Survey_on_Sentiment_Analysis_Challenges)
 - [10 Text Mining Examples](https://www.expertsystem.com/10-text-mining-examples/)
...
You should also think about and understand the impact this program or approach to text mining and analysis could have on others in the real world. Some questions to consider when writing the reflection:
 - How might the program be used to benefit others?
 - What are some of the program’s limitations?
 - What might be the impact of the program's limitations if used beyond what it's explicitly designed for?
