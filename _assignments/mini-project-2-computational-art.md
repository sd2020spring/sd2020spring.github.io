...
due: 2020-02-25 10:30:00 -05:00
gallery_due: 2020-02-24 17:00:00 -05:00
---
...
The idea of this assignment is to create art using computation as an artistic medium. As you saw in class, there are a ton of interesting ways to combine computation and art. In this assignment you will be exploring one particular means of using computers to generate images. We also encourage you to think about what "computational creativity" is, what it means to create art computationally, how it differs from art in the traditional sense, and how it fits in today’s society.

For the "going beyond" portion you will have the opportunity to extend your work by exploring topics such as computational generation of movies and real-time visualization of auditory signals.
...
![]({% link images/assignments/computational-art/complex_blue_surface.png %}){:width="320px" height="240px"}
...
answers, but we do think that these pictures look really cool!)
 ...
 - [Afrofuturist Artist Creates Stunning Portraits of Black Artists With Deep Dream AI Algorithms](https://nwn.blogs.com/nwn/2019/01/nettrice-gaskins-art-afrofuturist-kendrick-sade-nnedi-ai-deep-dream.html)
 - [Vincent van Bot: the robots turning their hand to art](https://www.theguardian.com/artanddesign/2016/apr/19/robot-art-competition-e-david-cloudpainter-bitpaintr)
...
1. Click on the invitation link at <{{ site.data.github.compart_invite }}>
1. Accept the assignment and follow the instructions to get to your repository page, which looks something like <https://github.com/{{ site.data.github.organization }}/ComputationalArt-myname>
1. Clone the repository to your computer. The starter code is in `recursive_art.py`.

In addition to fetching the starter code, you should also install the [Pillow fork](https://pillow.readthedocs.org/) of the Python Imaging Library
...
checkout the images after you have saved them to a file), I recommend using **pygame**.
...
(for the main assignment, all code will be in `recursive_art.py`.
Submit a link on Canvas to your `recursive_art.py` on GitHub.
If you
...
* The additional functions you used to create the artwork (beyond the basic set of ```prod```, ```cos```, ...)
...
[here](https://www.gyst-ink.com/artist-statement-guidelines).

In order to make it into the exhibition you should submit your art no later than: {{ page.gallery_due | date: site.part_due_date_format }}.
