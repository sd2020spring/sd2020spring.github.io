...
- name: Project Proposal
  due: 2018-10-15 17:00:00 -04:00
  tag: project-proposal
- name: Mid-Project Check-in
  due: 2018-10-18 10:50:00 -04:00
...
* Make sure that you and your partner are on the same page in terms of project topic.
* Revisit preferred working styles with your partner.
...
Find a partner and decide upon a project topic. You are required to have a a rough idea of what you will do
for the project) by {{ part.due | date: '%-I:%M %P on %a %b %-d' }}.
We will use a shared spreadsheet (link on Canvas) to facilitate generation of ideas and locating interested partners. Once you have a team and an idea, list yourselves in the "Teams" tab of the spreadsheet.

You can accept the [assignment on GitHub classroom]({{ site.data.github.interactive_invite }}), invite your partner to the repository (remember: repos are public this time), clone the repo to your computer and get started working on your proposal.
...
By the following day, your MP4 repo should have a proposal document (markdown or PDF, submit a link on Canvas) that describes the main idea of your project.
...
We are requiring a mid-project check-in for this project. You must meet with course staff by {{ part.due | date: site.part_due_date_format }}.
