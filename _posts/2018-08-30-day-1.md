...
The [Powerpoint presentation](/files/slides/Day01.pptx) for today (and a [PDF version](/files/slides/Day01.pdf) of it) are available.
...
* Finish any of the activities in this page that you didn't during class (we don't expect you to get through all of it in class).
